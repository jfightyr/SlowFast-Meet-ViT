...
class ACARHead(nn.Module):
    def __init__(self, width, roi_spatial=7, num_classes=60, dropout=0., bias=False,
        ...
        self.BN_vit = nn.BatchNorm3d(1408)
        self.conv_auto = nn.Conv3d(in_channels=1408, 
                                   out_channels=1408, 
                                   kernel_size=(1, 3, 3), 
    ...
    def forward(self, data):
        ...
        # feats: [slow, fast, vit]
        # added module for adjust and normalization
        feats[2] = self.BN_vit(feats[2])
        feats[2] = self.conv_auto(feats[2])
