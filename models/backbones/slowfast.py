...
class SlowFast(nn.Module):
    ...
    def forward(self, input):
        ...
        return [slow, fast]
        # CW dataset, resize of 256
        # slow torch.Size([1, 2048, 8, 16, 29])
        # fast torch.Size([1, 256, 32, 16, 29])
        
        # CW dataset, resize of [224,224]
        # slow torch.Size([1, 2048, 8, 14, 14])
        # fast torch.Size([1, 256, 32, 14, 14])
